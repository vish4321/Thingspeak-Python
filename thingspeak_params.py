#TO ADAPT THIS FOR ANY APPLICATION, CHANGE ONLY THESE VALUES
...
#Enter your label map here.
#Ensure list index corresponds to class label; if the labels start from 1, add a leading 'null' to this list.
#Warning: make sure the list length is no greater than 99. Two character limit on the encoding size.
